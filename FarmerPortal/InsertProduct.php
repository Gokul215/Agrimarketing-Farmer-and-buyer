                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form name="my-form" action="dbInsert.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number5" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder">Phone:</label>
                                        <div class="col-md-6">
                                            <input type="number" id="nid_number5" class="form-control" name="phonenumber" placeholder="phone" required>
                                        </div>
                                    </div>
